...
prf refl refl refl (step-NoOp p ([[ pc , reg , mode , UR , SR , ret_pc ]]) prf₁ cmd-prf) = [ pc , reg ] , {!   !} , {!   !} , {!   !}
prf refl refl refl (step-Add {n} {dest} {r1} {r2} p ([[ pc , reg , true , _ , _ , _ ]]) prf₁ cmd-prf) = [ suc (pc) , _ ] , {!   !} , refl , refl
